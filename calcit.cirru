...
{} (:package |app)
  :configs $ {} (:init-fn |app.client/main!) (:reload-fn |app.client/reload!) (:storage-key |calcit.cirru)
                  ...
                  div
                    ...
                    div ({})
                      input $ {} (:style style/input)
                        ...
                        :placeholder |Title
                        :on-input $ fn (e d!)
                          d! cursor $ assoc state :title $ assert-type (:value e) :any
                    =< nil 16
                    textarea $ {}
                      ...
                      :value $ :content state
                      :on-input $ fn (e d!)
                        d! cursor $ assoc state :content $ assert-type (:value e) :any
                  =< nil 16
                  div
                    {} $ :style
                    ...
                    div
                      ...
                      div ({})
                        input $ {} (:placeholder |Username)
                          ...
                          :style ui/input
                          :on-input $ fn (e d!)
                            d! cursor $ assoc state :username $ assert-type (:value e) :any
                      =< nil 8
                      div ({})
                        input $ {} (:placeholder |Password)
                          ...
                          :style ui/input
                          :on-input $ fn (e d!)
                            d! cursor $ assoc state :password $ assert-type (:value e) :any
                    =< nil 8
                    div
                      {} $ :style
                        {} $ :text-align :right
